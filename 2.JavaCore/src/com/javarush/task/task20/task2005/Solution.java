...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            File your_file_name = new File("C:\\Temp\\outAssets.txt");
            ...
            for(Asset a : ivanov.assets) System.out.println(a.getName() + " " + a.getPrice());
            for(Asset a : somePerson.assets) System.out.println(a.getName() + " " + a.getPrice());
